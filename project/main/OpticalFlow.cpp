...
void OpticalFlow::generate_shape_points(const std::vector<Objects* > & m_list_gt_objects) {
...
void OpticalFlow::generate_collision_points_mean(const std::vector<Objects* > & m_list_gt_objects, const std::vector<Objects* > & m_list_simulated_objects) {
