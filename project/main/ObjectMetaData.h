...
class ObjectMetaData {
    ...
    ObjectPosition m_objectMetaData_position;
...
public:
    ...
    ObjectMetaData() {};
    ObjectMetaData(ObjectImageShapeData shape, ObjectDimensions dimension, ObjectPosition position, std::string name, ushort startPoint) :
