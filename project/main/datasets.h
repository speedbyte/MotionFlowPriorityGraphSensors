...
#define MAX_ITERATION_RESULTS 34 // 60 generate result. this cannot be more than vector

#define MAX_ITERATION_GT_SCENE_GENERATION_VECTOR MAX_ITERATION_RESULTS+1   // generate_obj_base_pixel_position_pixel_displacement vector
