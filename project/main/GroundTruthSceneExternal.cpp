...
void GroundTruthSceneExternal::read_gt_scene_data() {
...
void GroundTruthSceneExternal::convert_sensor_image_to_object_level(std::unique_ptr<Noise> &noise, std::vector<GroundTruthObjects> &list_of_gt_objects_base, std::vector<Sensors> &list_of_gt_sensors_base) {
