...
input_folder = "/local/git/MotionFlowPriorityGraphSensors/datasets/vires_dataset/data/stereo_flow/three/blue_sky/"
input_folders.append(input_folder)

#input_folder = "/local/git/MotionFlowPriorityGraphSensors/datasets/vires_dataset/data/stereo_flow/three/light_snow/"
#input_folders.append(input_folder)

#input_folder = "/local/git/MotionFlowPriorityGraphSensors/datasets/vires_dataset/data/stereo_flow/three/mild_snow/"
#input_folders.append(input_folder)

input_folder = "/local/git/MotionFlowPriorityGraphSensors/datasets/vires_dataset/data/stereo_flow/three/heavy_snow/"
input_folders.append(input_folder)
