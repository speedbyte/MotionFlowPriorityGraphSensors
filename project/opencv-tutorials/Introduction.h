...
/** brief
 ...
 cv::randu() - create random array from min number and max number. This is a compile time function.
 Generated by Multiply with Carry Algorithm.
 cv::randn() - create random array from mean and standard deviation.
