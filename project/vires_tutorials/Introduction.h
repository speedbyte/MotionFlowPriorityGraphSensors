...
Our evaluation server computes the percentage of bad pixels averaged over all ground truth pixels of all 200 test images.

Stereo and Optical flow benchmark comprises of 200 Training and 200 Test Image pairs at a resolution of half a megapixel.
...
The laser power varies from 1 mw ( Laser pointers ) to  100s of watts ( Outdoor shows for example Audience scanning  ) to MW ( Laser telescopes )


Faster and still Reliable Sensor Fusion.

Trying to solve this by making a generic framework and inducing 4 important details in the framework: Confusion, Consistency, Compromise and Confidence.
...
Rays have no thickness, but beams are shaped as unbounded pyramids with polygonal cross sections. The idea is since 1984.
